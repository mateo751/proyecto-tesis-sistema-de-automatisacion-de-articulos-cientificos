...
class InvestigacionFormModel:
    ...
    def crear_investigacionForm(self, data: Dict[str, Any]) -> int:
        """
        ...
        try:
            ...
            investigacionForm = {
                ...
                'pico_response': data.get('pico_response'),
                'anio_inicio': data['anio_inicio'],
                'anio_fin': data['anio_fin'],
                'query': data['query'],
                'fuentes_response': data.get('fuentes_response'),
    ...
    def obtener_investigacionForm(self) -> List[Dict[str, Any]]:
        """
    ...
    def obtener_investigacion_por_id(self, id: int) -> Dict[str, Any]:
        """
    ...
    def actualizar_investigacionForm(self, id: int, data: Dict[str, Any]):
        """
    ...
    def eliminar_investigacionForm(self, id: int):
        """
